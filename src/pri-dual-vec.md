...
<center>**Graphical summary of Primal, Dual, DoF (dofs), and True DoF (tdofs) vectors**</center>
![](img/FEM-LA-Diagrams.png)

## Primal Vectors

The finite element method is based on the notion that a smooth function can be
approximated by a sum of piece-wise smooth functions (typically piece-wise polynomilas) called *basis functions*:
