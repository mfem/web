...
- **Example 1** ([ex1.cpp](https://github.com/mfem/mfem/blob/master/examples/ex1.cpp) and
    ...
    The image corresponds to the 2nd sample run with <kbd>i</kbd>, <kbd>Z</kbd> and <kbd>m</kbd> pressed in the GLVis window, followed by rotation with the mouse <kbd>Left</kbd> button.
...
- **Example 2** ([ex2.cpp](https://github.com/mfem/mfem/blob/master/examples/ex2.cpp) and
    ...
    The image corresponds to the 2nd sample run with <kbd>m</kbd> pressed in the GLVis window.
...
- **Example 3**  ([ex3.cpp](https://github.com/mfem/mfem/blob/master/examples/ex3.cpp) and
    ...
    The image corresponds to the 3rd sample run with <kbd>m</kbd> pressed in the GLVis window.
...
- **Example 4** ([ex4.cpp](https://github.com/mfem/mfem/blob/master/examples/ex4.cpp) and
    ...
    The image is similar to the 1st sample run with <kbd>R</kbd>, <kbd>j</kbd> and <kbd>l</kbd> pressed in the GLVis window.
