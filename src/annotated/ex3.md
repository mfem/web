...
\nabla \times \nabla \times E + E = f,
$$
corresponding to a simple model of electromagnetic diffusion. The boundary condition is given by setting $E \times n$ equal to some given tangential field $g$. 
...
<div class="panel-body">
To learn more about electromagnetics simulations in MFEM, visit the  <a href="../../maxwell-notes"><i class="fa fa-play-circle"></i>&nbsp; Maxwell's Equations</a> and <a href="../../electromagnetics"><i class="fa fa-play-circle"></i>&nbsp; Electromagnetics Mini Applications</a> documentation pages.
</div>
</div>
