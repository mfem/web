...
$$
corresponding to a simple model of electromagnetic diffusion with permeability and conductivity parameters $\mu>0$ and $\sigma>0$, respectively. The boundary condition is given by setting $E \times n$ equal to some given tangential field $g$. 
...
The source file [examples/ex3.cpp](https://github.com/mfem/mfem/blob/master/examples/ex3.cpp) implements the electromagnetics problem described above.
