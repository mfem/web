...
Complete the <a href="../../tutorial/fem"><i class="fa fa-play-circle"></i>&nbsp;
Example 1</a> tutorial before starting this lesson.
</div>
</div>
...
We will discretize and solve this problem using the [proximal Galerkin](https://doi.org/10.1007/s10208-024-09681-8) finite
element method, introduced by Keith and
Surowiec. In this method, given linear
...
[^1]: For a more complete description of the algorithm, see Algorithm 4 in \[v5\] of the [arXiv preprint](https://arxiv.org/abs/2307.12444v5).
